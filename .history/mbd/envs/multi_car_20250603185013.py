    ...
    def get_rewards(self, q_all, u_all):
        ...
        def single_reward(k, q,u_all):
            ...
            def single_obs_penalty(p, obstacle):
                ...
                # Penalità sigmoide
                return 1.0 / (1.0 + jnp.exp(-10.0 * (dist - self.Ra)))
            if self.obstacles_enabled
                ...
                r_obstacles = 0.0  # No penalty if obstacles are disabled
            ...
            return r_goal + self.wt * r_safe + r_form + 0.1*r_control+0.5* r_obstacles
