...
class MultiCar2d:
    ...
    def get_rewards(self, q_all, u_all):
        ...
        def single_reward(k, q,u_all):
            ...
            r_safe =self.wt* compute_r_safe(q[:2], q_all, k, self.Ra) # funziona sia per ostacoli che senza e 
            # self.wt deve essere =2 quando non ho gli ostacoli fissi, mentre pari a 1 quando ho gli ostacoli fissi
