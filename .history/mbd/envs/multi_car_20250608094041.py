    ...
    def get_rewards(self, q_all, u_all):
        ...
        def single_reward(k, q,u_all):
            ...
            def single_obs_reward(p, obstacle, pT):
                ...
                # ma aggiungo un bonus se sono vicino all’ostacolo **e** anche al goal
                bonus = jnp.exp(-dist_to_obstacle * 3) * jnp.exp(-dist_to_goal * 1.5)

                return penalty+2* bonus 
            ...
            r_motion = jnp.linalg.norm(u_k)

            return 10 * r_goal + 20 * r_safe + r_obstacles + 0.25 * r_form + 0.1 * r_control+r_motion
