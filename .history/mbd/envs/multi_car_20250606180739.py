...
class MultiCar2d:
    def __init__(self, n, radius=2.0, robot_radius=0.1,formation_shift = False,obstacles_enabled=False,ECD=False):
        ...
        if obstacles_enabled:
            ...
            #  ⇒ quadrato interno 1.6 m × 1.6 m (prima era 2.0 m × 2.0 m)
            self.static_obstacles = jnp.array([
                [0.0,  0.8, 1.6, 0.07],   # parete orizzontale in alto
                [0.0, -0.8, 1.6, 0.07],   # parete orizzontale in basso
                [-0.8, 0.0, 0.07, 1.6],   # parete verticale a sinistra
                [ 0.8, 0.0, 0.07, 1.6],   # parete verticale a destra
            ])
