...
def log_barrier_pairwise(p_k, others_pos, Ra, epsilon=1e-3):
    """
    Calcola una penalità log-barrier rispetto alle posizioni degli altri robot.
    """
    diffs = others_pos - p_k  # (n-1, 2)
...
class MultiCar2d:
    ...
    def get_rewards(self, q_all, u_all):
        ...
        def single_reward(k, q,u_all):
            ...
            others_pos = jnp.concatenate([q_all[:k, :2], q_all[k+1:, :2]], axis=0)
            r_safe = -log_barrier_pairwise(q[:2], others_pos, self.Ra)
