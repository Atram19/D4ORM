    ...
    def __init__(self, n, radius=2.0, robot_radius=0.1,formation_shift = False,obstacles_enabled=False,ECD=False):
        ...
        if obstacles_enabled:
            ...
            # ])
                ...
                self.static_obstacles = jnp.array([
                    [0.0,  1.0, 1.0, 0.1],  # Ostacolo orizzontale in alto
                    [0.0, -1.0, 1.0, 0.1],  # Ostacolo orizzontale in basso
                    [-1.0, 0.0, 0.1, 1.0],  # Ostacolo verticale a sinistra
                    [ 1.0, 0.0, 0.1, 1.0],  # Ostacolo verticale a destra
                ])
