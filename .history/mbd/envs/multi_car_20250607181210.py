...
class MultiCar2d:
    ...
    def get_rewards(self, q_all, u_all):
        ...
        def single_reward(k, q,u_all):
            ...
            def single_obs_reward(p, obstacle, p_goal):
                """
                ...
                dist_to_goal = jnp.linalg.norm(p - p_goal)
            ...
            if self.obstacles_enabled:
                ...
                r_obs_vals = jax.vmap(lambda obs: single_obs_reward(p, obs))(obstacles)
                r_obstacles = jnp.max(r_obs_vals, axis=-1)  # max per robot, poi media
