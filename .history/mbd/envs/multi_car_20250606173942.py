...
class MultiCar2d:
    ...
    def get_rewards(self, q_all, u_all):
        ...
        def single_reward(k, q,u_all):
            ...
            vel_norm = jnp.linalg.norm(u_k[:2])  # supponendo che i primi 2 controlli siano velocità lineari
            r_stuck = -jnp.where(vel_norm < soglia, penalita_fissa, 0.0)
            ...
            return r_goal +  r_safe + r_form + 0.1*r_control+1* r_obstacles+r_stuck
