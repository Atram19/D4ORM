...
def make_lagrangian_fn(state_init, env, Nsample):
    ...
    def lagrangian(Y0s_windows, Y0s, pipeline_states,pipeline_states_window, lambda_goal, mu_k):
        ...
        L_cost_local = control_cost_local +  30*barrier_cost_local  + 20* goal_cost_local+15*formation_cost_local+ 500*obstacle_cost_local
        L_cost_global =  control_cost_global + 30*barrier_cost_global + 20* goal_cost_global+15*formation_cost_global+500*  obstacle_cost_global
