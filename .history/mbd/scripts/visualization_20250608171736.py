...
def run_diffusion_local(args: Args, U_init: jnp.ndarray, env, rollout_us, reset_env_jit):
    ...
    def ecd_refinement_local(U_start, lambda_start, args, env, rollout_us, reset_env_jit):
        ...
        for t_start in range(0, H - L + 1, L // 2):
            ...
            for i in range(N_inner):
                ...
                grad = grad / (Nsample * sigma_k**2 + 1e-8)
    ...
    def ecd_refinement(U_start, lambda_start, rews):
        ...
        for i in range(30):
            ...
            grad = jnp.einsum("s,slij->lij",stim , eps_u)
    ...
    #U_refined, lambda_goal = ecd_refinement_local(U, lambda_goal, args, env, rollout_us, reset_env_jit)
