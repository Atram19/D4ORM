...
def main():
    ...
    if not args.not_render:
       ...
       # Save final trajectory plot
        ...
        plot_and_save_reward_terms(r_terms_all_local, path=output_dir_local, prefix=f"reward_local/reward_plot_{ecd_tag}_{formation_tag}",component_names=component_names)
        plot_and_save_reward_terms(r_terms_all_global, path=output_dir_global, prefix=f"reward/globalreward_plot_{ecd_tag}_{formation_tag}",component_names=component_names)
