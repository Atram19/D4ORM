...
def main():
    ...
    def plot_and_save_reward_terms(r_terms_all, path, prefix="reward", robot_ids=None, component_names=None):
        ...
        for j in range(num_terms):
            ...
            plt.close()
            print(f"✔️ Salvato: {os.path.join(path, filename)}")
    ...
    if not args.not_render:
        ...
        plot_and_save_reward_terms(r_terms_all, path=path, prefix=f"reward_plot_{ecd_tag}_{formation_tag}",component_names=component_namesS)
