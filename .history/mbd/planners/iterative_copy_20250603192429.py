...
def run_diffusion_local(args: Args, U_init: jnp.ndarray,env, rollout_us, reset_env_jit):
    ...
    def reverse_once_local_hybrid(U_window, rng_w, U_full_template, t_start, residual_fn, lagrangian_fn, lambda_goal, args, env,sigma_k):
        ...
        sigma_local = 0.2 if args.obstacles_enabled else sigma_k
        ...
        # print("goal_cost NaN:", jnp.isnan(goal_cost).any())
        # print("barrier_cost NaN:", jnp.isnan(barrier_cost).any())
        # print("rewss NaN:", jnp.isnan(rewss).any())
        # print("h NaN:", jnp.isnan(h_flat).any())
        # print("obstacle_cost_local NaN:", jnp.isnan(obstacle_cost_local).any())
    ...
    noise_norm = []
    for i in range(30):  # numero iterazioni locali
