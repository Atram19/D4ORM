...
def run_diffusion_local(args: Args, U_init: jnp.ndarray, env, rollout_us, reset_env_jit):
    ...
    def reverse_once_local_hybrid(U_window, rng_w, U_full_template, t_start, residual_fn, lagrangian_fn, lambda_goal, args, env,sigma_local,alphas_bar_local):
        ...
        for j in reversed(range(1, L)):
            ...
            U_soft = jnp.sqrt(alphas_bar_local[j - 1]) * U_soft
