...
def run_diffusion_once(args: Args,env, rollout_us, reset_env_jit):
    ...
    def reverse(YN, rng):
        ...
        for i in reversed(range(1,100)):
            ...
            Y0s = Y0s.reshape(args.Nsample, args.Hsample, args.num_robots, env.action_size)
    ...
    np.savez("results/multicar_iterative/global_Yi_list.npz", Yi_list=np.array(Yi_list),Y0s_list=np.stack(Y0s_list))
