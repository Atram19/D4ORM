...
def reverse_once(carry):
    ...
    Ybar_im1 = Yim1 / jnp.sqrt(alphas_bar[i - 1])
    return (i - 1, rng, Ybar_im1)
def run_diffusion_once(args, env, rollout_us, reset_env_jit):
    ...
    Yi_list = []
    Y0s_list = []
...
def main():
    ...
    if not args.not_render:
        ...
        state_init = reset_env_jit(jax.random.PRNGKey(args.seed + 2048))
